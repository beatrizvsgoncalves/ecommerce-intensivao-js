...
function desenharProdutoNoCarrinho(idProduto) {
    ...
    <button id="remover-item-${
      ...
      <i class="fa-solid fa-x text-slate-600 hover:text-slate-900"></i>
    </button>
    ...
    <div class="flex text-slate-950 text-md items-end absolute bottom-1 right-1 border-2 border-slate-500 bg-slate-300 rounded-md">
    <button id="decrementar-produto-${
			produto.id
		}" class="px-1.5"><i class="fa-solid fa-minus fa-xs"></i></button>
    <p id="quantidade-${
			produto.id
		}"class="bg-slate-200 px-2 border-2 border-x-slate-500 font-semibold">${
		idsProdutoCarrinhoComQuantidade[produto.id]
	}</p>
    <button id="incrementar-produto-${
			produto.id
		}" class="px-1.5"><i class="fa-solid fa-plus fa-xs"></i></button>
    </div>`;
